...
#ifndef _ATMEGA16REGMAP_H_
/**
 * @defgroup ATMEGA16REGMAP_H_GROUP Atmega16regmap definitions
 * @brief Related atmega16regmap definitions.
 * @{
 */
/**
 * @def _ATMEGA16REGMAP_H_
 * @brief Definition for _ATMEGA16REGMAP_H_.
 */
#define _ATMEGA16REGMAP_H_
